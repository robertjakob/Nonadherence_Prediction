...
# Load dataset
df = pd.read_csv('manoa.csv')

# Adjusted target variables (Churn1 to Churn90)
target_variables = [f'Churn{i}' for i in range(8, 187)]
...
with Tee('ManoaChurn.txt'):
    # Iterate over feature sets
    for i in range(1, 187):  # Adjusted range according to the logic provided
        exercise_features = [f'logins{j}' for j in range(1, i + 1)]
